...
//public class WardHandler extends TextWebSocketHandler {
//
...
//
//        // 사용자 uuid를 세션과 매핑
//        sessions.put(toMemberUuid, session); // 세션을 사용자 uuid로 저장
...
//            NotificationDto resDto = new NotificationDto(reqDto.getFromMemberUuid(), fromMemberName, toMemberUuid);
