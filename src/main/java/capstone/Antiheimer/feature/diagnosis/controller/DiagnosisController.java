...
//        AiResDto aiResDto = diagnosisService.getDiagnosisResult(request);
        AiSendDto aiSendDto = diagnosisService.getDiagnosisResult(request);
...
//        return new ResponseEntity<>(new DiagnosisResultResDto("200", "진단 결과 저장 및 치매진단 성공", aiResDto), HttpStatus.OK);
        return new ResponseEntity<>(new DiagnosisResultResDto("200", "진단 결과 저장 및 치매진단 성공", aiSendDto), HttpStatus.OK);
